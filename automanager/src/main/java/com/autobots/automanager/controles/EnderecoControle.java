...
public class EnderecoControle {
    ...
    public ResponseEntity<?> atualizarEndereco(@RequestBody Endereco atualizar) {
        HttpStatus status = HttpStatus.CONFLICT;
        Endereco endereco = repositorio.getById(atualizar.getId());
        if (endereco != null) {
    ...
    public ResponseEntity<?> excluirEndereco(@RequestBody Endereco excluir) {
