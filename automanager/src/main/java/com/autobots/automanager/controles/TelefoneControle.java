...
public class TelefoneControle {
    ...
    public ResponseEntity<?> atualizarTelefone(@RequestBody Telefone atualizar) {
        HttpStatus status = HttpStatus.CONFLICT;
        Telefone telefone = repositorio.getById(atualizar.getId());
        if (telefone != null) {
    ...
    public ResponseEntity<?> excluirTelefone(@RequestBody Telefone excluir) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        Telefone telefone = repositorio.getById(excluir.getId());
        if (telefone != null) {
