...
import com.autobots.automanager.controles.CredencialCodigoBarraController;
...
public class AdicionadorLinkCredencialCodigoBarra implements AdicionadorLink<CredencialCodigoBarra> {
    ...
    public void adicionarLink(List<CredencialCodigoBarra> lista) {
        for (CredencialCodigoBarra credencial : lista) {
            ...
            Link linkProprio = WebMvcLinkBuilder
                    .linkTo(WebMvcLinkBuilder.methodOn(CredencialCodigoBarraController.class).obterCredencial(id))
                    .withSelfRel();
    ...
    public void adicionarLink(CredencialCodigoBarra objeto) {
        Link linkProprio = WebMvcLinkBuilder
                .linkTo(WebMvcLinkBuilder.methodOn(CredencialCodigoBarraController.class).obterCredenciais())
                .withRel("credenciais");
